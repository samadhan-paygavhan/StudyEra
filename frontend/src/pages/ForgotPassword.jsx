...
const ForgotPassword = () => {
  ...
  return (
    <div className="relative w-full h-[760px] bg-[#fcfcfd] overflow-hidden">
      <div className="min-h-screen flex flex-col">
        {/* Main content */}
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="w-full max-w-md space-y-6">
            <div className="text-center space-y-2">
              <h1 className="text-3xl font-bold tracking-tight text-[#483D8B]">
                Reset Your password
              </h1>
            ...
            <Card className="bg-white">
              <CardHeader className="space-y-1">
                <CardTitle className="text-2xl text-center text-[#483D8B]">
                  Forgot Password
                </CardTitle>
              ...
              <CardContent className="space-y-4">
                ...
                {isSubmitted ? (
                  ...
                  <form onSubmit={handleForgotPassword} className="space-y-4">
                    ...
                    <Button className="w-full bg-[#483D8B] text-white relative hover:bg-[#584D9B] cursor-pointer">
                      {isLoading ? (
                        <>
